...
<table class="formtable">
    ...
    <tr>
        ...
        <td><input type="number" required class="forminput" name="ForceNo" value=""></td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" required class="forminput" name="SSOwnershipNo" value=""></td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" required class="forminput" name="Successer" value=""></td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" required class="forminput" name="HomeNo" value=""></td>
    </tr>
