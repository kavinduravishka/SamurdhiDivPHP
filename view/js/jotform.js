    ...
    handlePaymentSubProducts: function () {
        ...
        function showSubProducts(el) {
            ...
            if (!el.checked) {
              ...
              if (el.value && el.value.indexOf('_expanded') > -1 && productSpan.querySelector('.form-product-description').childNodes[0] && productSpan.querySelector('.form-product-description').childNodes[0].nodeValue.trim() !== "") {
                  productSpan.shift({
