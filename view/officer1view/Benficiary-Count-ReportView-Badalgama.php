...
<html lang="en">
<head>
    <meta name="pagedata" tab="task" type="report" title="Report - Badalgama">
    <title>Beneficiary Count Report Badalgama</title>
    <link rel="stylesheet" href="/SamurdhiDivPHP/view/css/main.css">
...
<body>
    ...
    <main>
        <div class="maincontainer">
          ...
          <caption><h3>සමුර්ධි ප්‍රජාමූල බැංකුවේ නම :- බඩල්ගම </h3></caption>
          <tr>
