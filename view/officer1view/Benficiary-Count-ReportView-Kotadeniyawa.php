...
<html>
<head>
  <meta name="pagedata" tab="task" type="report" title="Report - Kotadeniyawa">
 ...
 <script type="text/javascript" src="/SamurdhiDivPHP/view/js/ksidebar.js"></script>
    ...
    <main>
      ...
      <table class="masterlist">
          ...
          <caption><h3>සමුර්ධි ප්‍රජාමූල බැංකුවේ නම :- කොටදෙනියාව </h3></caption>
          <tr>
		...
		<form action="Benficiary-Count-ReportView-Kotadeiyawa.php?type=7" method="post">
