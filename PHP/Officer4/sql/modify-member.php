...
<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($errors)){
            ...
            $query.=",date_of_birth='{$date_of_birth}',date_of_pension='{$date_of_pension}',w_op_number='{$w_op_number}' WHERE member_id='{$member_id}' LIMIT 1 ";
...
<body>
    ...
    <main>
        <h1>View / Modify Personal-file<span><a href="personal-files.php">Back to Personal-file List</a></span></h1>
        ...
        <form action="modify-member.php" method="post" class="modifymemberform" >
