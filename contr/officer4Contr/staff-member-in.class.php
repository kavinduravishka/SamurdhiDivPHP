...
class StaffMemberIn extends StaffMember {
    ...
    public function addMember(){
        ...
        $stmt->execute([$this->nic_number, $this->name , $this->designation , $this->service ,$this->date_appointed ,$this->date_of_birth ,$this->date_of_pension ,$this->w_op_number, 'in',0]);
